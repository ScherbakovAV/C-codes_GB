...
// else Console.WriteLine("Введён неверный оператор");

// System.Console.WriteLine("Для продолжения нажэмите Enter, для выхода '.'");
...
// Опросник с 4 вариантами ответов, подсказка 50/50, подсчёт правильных ответов, 10 вопросов
...
Console.WriteLine($"\nДля выюора ответа введите цифры от 1 до 4, для подсказки введите 5");
Console.WriteLine($"\nНажмите Enter...\n");
Console.ReadKey();
...
for (int i = 0; i < questions.Length; i++)
{
    ...
    if (answers[i, result - 1] == answers[i, 4])
    {
        Console.WriteLine("Это правильный ответ!");
        count++;
    }
    else Console.WriteLine("Это неправильный ответ..");
    Console.WriteLine("");  
}
