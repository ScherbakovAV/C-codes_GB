...
int[,] GetArrayRandom(int rows, int columns, int MinValue = 1, int MaxValue = 10) // для задач 46, 49, 51
{
    int[,] array = new int[rows, columns];

    Console.WriteLine($"\nЭтот массив со случайными элементами от {MinValue} до {MaxValue - 1}:\n");
